#ifndef TWOTUBEAUTONOMOUSCONTROLLER2415_H_
#define TWOTUBEAUTONOMOUSCONTROLLER2415_H_
...
class TwoTubeAutonomousController2415 : public Task2415 {
private:
	Global *global;

	DigitalInput *psLeft, *psMid, *psRight;

	Timer *moveTimer, *turnTimer, *stopTimer, *backTimer, *forTimer, *gripTimer, *hardTimer;

	Task2415 *drive, *lift, *scoreController, *gripper, *arm;

public:
	TwoTubeAutonomousController2415(void);
